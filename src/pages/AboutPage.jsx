...
const AboutPage = () => {
  return (
    <div className="min-h-screen relative bg-slate-900 py-24 md:py-24">
      <AboutBackgroundAnimation />
      
      {/* Content container with proper contrast */}
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              >
                ...
                <h3 className="text-xl font-bold text-white mb-3">Missed Cancers</h3>
              ...
              >
                ...
                <h3 className="text-xl font-bold text-white mb-3">Radiologist Workload</h3>
                <p className="text-slate-300 text-sm">
              ...
              >
                ...
                <h3 className="text-xl font-bold text-white mb-3">Late Diagnosis in LMICs</h3>
                <p className="text-slate-300 text-sm">
              ...
              >
                ...
                <h3 className="text-xl font-bold text-white mb-3">Variability in Readings</h3>
                <p className="text-slate-300 text-sm">
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              >
                <h3 className="text-2xl font-bold text-cyan-400 mb-4">To Hospitals & Screening Centers</h3>
              ...
              <motion.div
                ...
                className="bg-slate-800/30 backdrop-blur-sm rounded-xl p-8 border border-slate-700/50"
              >
                <h3 className="text-2xl font-bold text-green-400 mb-4">To Radiologists & Clinicians</h3>
                <ul className="space-y-3 text-slate-300">
                  <li className="flex items-start">
              ...
              <motion.div
                ...
                className="bg-slate-800/30 backdrop-blur-sm rounded-xl p-8 border border-slate-700/50"
              >
                <h3 className="text-2xl font-bold text-purple-400 mb-4">To Patients</h3>
                <ul className="space-y-3 text-slate-300">
                  <li className="flex items-start">
          ...
          >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
              <div>
                <h3 className="text-2xl font-bold text-cyan-400 mb-6">For Hospitals & Screening Centers</h3>
                <div className="space-y-6">
                  <div className="bg-slate-800/30 backdrop-blur-sm rounded-lg p-6 border border-slate-700/50">
                    <h4 className="font-semibold text-white mb-2">Improved Detection Rates</h4>
                    <p className="text-slate-300 text-sm">Our AI system achieves 98.5% sensitivity in clinical validation studies, helping detect cancers that might otherwise be missed during routine screening.</p>
                  </div>
                  
                  <div className="bg-slate-800/30 backdrop-blur-sm rounded-lg p-6 border border-slate-700/50">
                    <h4 className="font-semibold text-white mb-2">Reduced False Positives</h4>
                    <p className="text-slate-300 text-sm">Advanced algorithms reduce false positive rates by 25%, decreasing unnecessary biopsies and patient anxiety while optimizing resource allocation.</p>
                  </div>
                  
                  <div className="bg-slate-800/30 backdrop-blur-sm rounded-lg p-6 border border-slate-700/50">
                    <h4 className="font-semibold text-white mb-2">Seamless PACS Compatibility</h4>
                    <p className="text-slate-300 text-sm">Native integration with existing PACS systems and hospital networks, requiring minimal workflow disruption and IT infrastructure changes.</p>
                  </div>
                  
                  <div className="bg-slate-800/30 backdrop-blur-sm rounded-lg p-6 border border-slate-700/50">
                    <h4 className="font-semibold text-white mb-2">Scalable AI for High-Volume Screening</h4>
                    <p className="text-slate-300 text-sm">Cloud-based architecture designed to handle thousands of screenings daily while maintaining consistent performance and accuracy standards.</p>
                  </div>
                </div>
              </div>
              
              <div>
                <h3 className="text-2xl font-bold text-green-400 mb-6">For Radiologists</h3>
                <div className="space-y-6">
                  <div className="bg-slate-800/30 backdrop-blur-sm rounded-lg p-6 border border-slate-700/50">
                    <h4 className="font-semibold text-white mb-2">AI as Second Reader</h4>
                    <p className="text-slate-300 text-sm">Our system operates as an independent second reader, providing additional perspective without influencing initial radiologist interpretation.</p>
                  </div>
                  
                  <div className="bg-slate-800/30 backdrop-blur-sm rounded-lg p-6 border border-slate-700/50">
                    <h4 className="font-semibold text-white mb-2">Explainable Outputs</h4>
                    <p className="text-slate-300 text-sm">Visual heatmaps, region-of-interest highlighting, and confidence scores that support clinical decision-making with transparent AI reasoning.</p>
                  </div>
                  
                  <div className="bg-slate-800/30 backdrop-blur-sm rounded-lg p-6 border border-slate-700/50">
                    <h4 className="font-semibold text-white mb-2">Reduced Fatigue and Cognitive Load</h4>
                    <p className="text-slate-300 text-sm">Pre-analysis review and case prioritization help manage workload and reduce the mental strain of high-volume screening practice.</p>
                  </div>
                  
                  <div className="bg-slate-800/30 backdrop-blur-sm rounded-lg p-6 border border-slate-700/50">
                    <h4 className="font-semibold text-white mb-2">Decision Support, Not Automation Bias</h4>
                    <p className="text-slate-300 text-sm">Designed to enhance human judgment rather than replace it, maintaining radiologist autonomy and clinical expertise in patient care.</p>
                  </div>
                </div>
              </div>
            </div>
            
            <div className="bg-gradient-to-r from-purple-900/20 to-pink-900/20 backdrop-blur-sm rounded-2xl p-8 border border-slate-700/50">
              <h3 className="text-2xl font-bold text-purple-400 mb-6 text-center">For Patients</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="bg-slate-800/30 backdrop-blur-sm rounded-lg p-6 border border-slate-700/50">
                  <h4 className="font-semibold text-white mb-2">Earlier Detection</h4>
                  <p className="text-slate-300 text-sm">Enhanced screening capabilities increase the likelihood of detecting breast cancer at earlier, more treatable stages.</p>
                </div>
                
                <div className="bg-slate-800/30 backdrop-blur-sm rounded-lg p-6 border border-slate-700/50">
                  <h4 className="font-semibold text-white mb-2">Fewer Unnecessary Recalls</h4>
                  <p className="text-slate-300 text-sm">Improved specificity reduces the number of patients recalled for additional imaging or biopsies due to false positive results.</p>
                </div>
                
                <div className="bg-slate-800/30 backdrop-blur-sm rounded-lg p-6 border border-slate-700/50">
                  <h4 className="font-semibold text-white mb-2">Transparency and Trust</h4>
                  <p className="text-slate-300 text-sm">Clear communication about AI involvement in screening and diagnostic processes, with full disclosure to patients.</p>
                </div>
                
                <div className="bg-slate-800/30 backdrop-blur-sm rounded-lg p-6 border border-slate-700/50">
                  <h4 className="font-semibold text-white mb-2">Equitable Access</h4>
                  <p className="text-slate-300 text-sm">Expanding access to advanced screening technology regardless of geographic location or economic status.</p>
                </div>
              </div>
            </div>
          </motion.section>
          ...
          <motion.section
            ...
            className="mb-20"
          >
            <div className="bg-gradient-to-r from-slate-800/30 to-slate-900/30 backdrop-blur-sm rounded-2xl p-8 md:p-12 border border-slate-700/50">
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-8 text-center">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                <div>
                  <h3 className="text-2xl font-bold text-white mb-6">Daily Clinical Challenges</h3>
                  <div className="space-y-6">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-white mb-6">Workflow Pressures</h3>
                  <div className="space-y-6">
                    <div className="bg-slate-800/40 backdrop-blur-sm rounded-lg p-6 border border-slate-700/50">
                      <h4 className="font-semibold text-white mb-3 flex items-center">
          ...
          >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              <div>
                <h3 className="text-2xl font-bold text-white mb-6">Clinical Decision Support</h3>
                <div className="space-y-6">
                  <div className="bg-gradient-to-r from-blue-900/20 to-indigo-900/20 backdrop-blur-sm rounded-lg p-6 border border-blue-700/30">
                    <h4 className="font-semibold text-white mb-3 flex items-center">
                      <svg className="w-5 h-5 text-blue-400 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="bg-gradient-to-r from-green-900/20 to-teal-900/20 backdrop-blur-sm rounded-lg p-6 border border-green-700/30">
                    <h4 className="font-semibold text-white mb-3 flex items-center">
                      <svg className="w-5 h-5 text-green-400 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                      </svg>
                  ...
                  <div className="bg-gradient-to-r from-purple-900/20 to-pink-900/20 backdrop-blur-sm rounded-lg p-6 border border-purple-700/30">
                    <h4 className="font-semibold text-white mb-3 flex items-center">
                      <svg className="w-5 h-5 text-purple-400 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                      </svg>
              ...
              <div>
                <h3 className="text-2xl font-bold text-white mb-6">Workflow Enhancement</h3>
                <div className="space-y-6">
                  <div className="bg-gradient-to-r from-yellow-900/20 to-orange-900/20 backdrop-blur-sm rounded-lg p-6 border border-yellow-700/30">
                    <h4 className="font-semibold text-white mb-3 flex items-center">
                      <svg className="w-5 h-5 text-orange-400 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                      </svg>
                  ...
                  <div className="bg-gradient-to-r from-red-900/20 to-pink-900/20 backdrop-blur-sm rounded-lg p-6 border border-red-700/30">
                    <h4 className="font-semibold text-white mb-3 flex items-center">
                      <svg className="w-5 h-5 text-red-400 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 12l3-3 3 3 4-4M8 21l4-4 4 4M3 4h18M4 4h16v12a1 1 0 01-1 1H5a1 1 0 01-1-1V4z" />
                      </svg>
                  ...
                  <div className="bg-gradient-to-r from-indigo-900/20 to-purple-900/20 backdrop-blur-sm rounded-lg p-6 border border-indigo-700/30">
                    <h4 className="font-semibold text-white mb-3 flex items-center">
                      <svg className="w-5 h-5 text-indigo-400 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                      </svg>
            ...
            <div className="bg-gradient-to-br from-slate-800/30 to-slate-900/30 backdrop-blur-sm rounded-2xl p-8 md:p-12 border border-slate-700/50">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="text-center">
                  ...
                  <h3 className="text-xl font-bold text-white mb-4">Assistive, Not Authoritative</h3>
                  <p className="text-slate-300 text-sm">
                ...
                <div className="text-center">
                  ...
                  <h3 className="text-xl font-bold text-white mb-4">Clinical Decision-Making</h3>
                  <p className="text-slate-300 text-sm">
                ...
                <div className="text-center">
                  ...
                  <h3 className="text-xl font-bold text-white mb-4">Enhanced Expertise</h3>
                  <p className="text-slate-300 text-sm">
              ...
              <div className="mt-12 p-6 bg-slate-800/40 backdrop-blur-sm rounded-lg border border-slate-700/50">
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-semibold text-white mb-2">Commitment to Clinical Excellence</h4>
                    <p className="text-slate-300 text-sm">
          ...
          >
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">Our Leadership</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 max-w-6xl mx-auto">
              ...
              >
                <div className="w-32 h-32 mx-auto mb-6 rounded-full bg-slate-700 overflow-hidden border border-slate-600 flex items-center justify-center transition-all duration-200 hover:bg-slate-600">
                  <svg className="w-16 h-16 text-slate-400" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/>
                  </svg>
                </div>
                <h3 className="text-xl font-bold text-white mb-2">Nivrutti Chavan</h3>
                <p className="text-cyan-400 font-medium mb-4">Chief Executive Officer & Founder</p>
              ...
              >
                ...
                <h3 className="text-xl font-bold text-white mb-2">Ram Kumar</h3>
                <p className="text-cyan-400 font-medium mb-4">Chief Technology Officer & Co-Founder</p>
                <p className="text-slate-300 text-sm leading-relaxed">
              ...
              >
                ...
                <h3 className="text-xl font-bold text-white mb-2">Kamesh P</h3>
                <p className="text-cyan-400 font-medium mb-4">Director of Machine Learning</p>
                <p className="text-slate-300 text-sm leading-relaxed">
              ...
              >
                ...
                <h3 className="text-xl font-bold text-white mb-2">Ajay Vardhrajan</h3>
                <p className="text-cyan-400 font-medium mb-4">Chief Public Health Officer</p>
                <p className="text-slate-300 text-sm leading-relaxed">
              ...
              >
                ...
                <h3 className="text-xl font-bold text-white mb-2">Dr. Prashant Patil</h3>
                <p className="text-cyan-400 font-medium mb-4">Chief Research Officer</p>
                <p className="text-slate-300 text-sm leading-relaxed">
              ...
              >
                ...
                <h3 className="text-xl font-bold text-white mb-2">Dr. Himmank</h3>
                <p className="text-cyan-400 font-medium mb-4">Chief Clinical Advisor</p>
                <p className="text-slate-300 text-sm leading-relaxed">
                  Dr. Himmank serves as Chief Clinical Advisor, providing strategic guidance on clinical implementation and medical affairs. With extensive experience in radiology and breast imaging, he ensures our AI solutions align with clinical best practices and regulatory requirements.
                </p>
              </motion.div>
            </div>
          </motion.section>
          ...
          >
            <div className="bg-gradient-to-r from-slate-800/50 to-slate-900/50 backdrop-blur-sm rounded-2xl p-12 border border-slate-700/50">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left max-w-5xl mx-auto">
                <div className="bg-slate-800/30 backdrop-blur-sm rounded-lg p-6 border border-slate-700/50">
                  <h3 className="text-lg font-semibold text-white mb-3">National Screening Programs</h3>
                  <p className="text-slate-300 text-sm">
                ...
                <div className="bg-slate-800/30 backdrop-blur-sm rounded-lg p-6 border border-slate-700/50">
                  <h3 className="text-lg font-semibold text-white mb-3">Global Accessibility</h3>
                  <p className="text-slate-300 text-sm">
                    Bringing advanced screening capabilities to underserved regions where specialist radiologist access is limited.
                  </p>
                </div>
                <div className="bg-slate-800/30 backdrop-blur-sm rounded-lg p-6 border border-slate-700/50">
                  <h3 className="text-lg font-semibold text-white mb-3">Clinical Excellence</h3>
                  <p className="text-slate-300 text-sm">
